    ...
    var lemoMenu = {
        ...
        renderSingleModule: function (menuList, menuChildOpen) {
            ...
            $.each(menuList, function (index, menu) {
                ...
                console.log(menu.title, '-1',  menu.child)
                    ...
                    var buildChildHtml = function (html, child) {
                        ...
                        $.each(child, function (childIndex, childMenu) {
                            ...
                            if (childMenu.child.length != 0) {
                                ...
                                console.log(childMenu.title, '-2',  childMenu.child)
                                html += '<a href="javascript:;" class="layui-menu-tips"  lemo-href="' + childMenu.href + '" ><i class="' + childMenu.icon + '"></i><span class="layui-left-nav"> ' + childMenu.title + '</span></a>\n';
                            }
                            html += '</dd>\n';
                        });
                        html += '</dl>\n';
