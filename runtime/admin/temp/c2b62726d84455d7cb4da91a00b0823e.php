<?php /*a:1:{s:55:"/www/php/work/tp5_layui/app/admin/view/login/index.html";i:1607482737;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    <title><?php echo site_name(); ?>后台管理-登陆</title>
    <meta name="keywords" content="cms 基于thinkphp6,thinkphp,layui,easywechat框架,框架,组件">
    <meta name="description" content="cms 是一款采用 layui开发的极简后台管理框架 基于thinkphp6 ,easywechat,开发的cms后台管理系统,thinkphp,cms,php后台管理系统,cms,cms系统,restful api,thinkphp后台管理系统">
    ...
    <div class="admin-login-background">
        <div class="layui-form login-form">
            <form class="layui-form" action="">
                ...
                <div class="copyright">
                    © 2018-2020 <a href="https://www.cms.com" target="_blank">cms.com</a> All Rights Reserved.
                </div>
            </form>
        </div>
    </div>
